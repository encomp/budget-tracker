import{a as e,n as t}from"./chunk-DnJy8xQt.js";import{t as n}from"./iframe-tWz5sYml.js";import{t as r}from"./jsx-runtime-BX9360Lk.js";import{a as i,c as a,r as o,t as s}from"./lucide-react-D10WrdMU.js";function c(){if(p||typeof document>`u`)return;let e=document.createElement(`style`);e.textContent=f,document.head.appendChild(e),p=!0}function l({type:e,size:t=20,className:n}){return u.useEffect(()=>{c()},[]),e===`LoaderCircle`?(0,d.jsx)(o,{size:t,className:`bp-icon-loading ${n??``}`}):e===`CheckCircle`?(0,d.jsx)(i,{size:t,className:`bp-icon-check ${n??``}`}):(0,d.jsx)(a,{size:t,className:`bp-icon-bell ${n??``}`})}var u,d,f,p,m=t((()=>{u=e(n(),1),s(),d=r(),f=`
@keyframes bp-spin {
